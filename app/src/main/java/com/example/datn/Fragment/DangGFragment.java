...
public class DangGFragment extends Fragment {
    ...
    public static void setUpViewDangG() {
    ...
    public static void getdataDangG() {
        APIService.apiService.Getalldonhangmua(maSV,2).enqueue(new Callback<List<DonHang>>() {
            ...
            public void onFailure(Call<List<DonHang>> call, Throwable t) {
                linearLayout.setVisibility(View.VISIBLE);
                Toast.makeText(donHangActivity.getApplication(), "Không tìm thấy đơn Đang giao" + donHangList.size(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void anhxa(View view) {
        ...
        recyclerView=view.findViewById(R.id.RecyclerViewDangGiaoH);
        linearLayout=view.findViewById(R.id.LinearLayoutDangGiaoH);
    }
}